...
if (!function_exists('alex_stone_booked_get_css')) {
	add_filter('alex_stone_filter_get_css', 'alex_stone_booked_get_css', 10, 4);
	function alex_stone_booked_get_css($css, $colors, $fonts, $scheme='') {
...
table.booked-calendar tr.days,
table.booked-calendar tr.days th {
	border-color: {$colors['extra_bd_color_03']} !important;
}
...
body .booked-modal a.booked-forgot-password:hover{
