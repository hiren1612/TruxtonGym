...
if (!function_exists('alex_stone_customizer_get_css')) {

	function alex_stone_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = alex_stone_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('alex_stone_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];

			
			// Border radius
			//--------------------------------------
			$rad = alex_stone_get_border_radius();
			$rad50 = ' '.$rad != ' 0' ? '50%' : 0;
			$css['fonts'] .= <<<CSS
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(alex_stone_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = alex_stone_get_scheme_colors($scheme);
...
table td, table th+td, table td+th, table td+td {
	border-color: {$colors['extra_bd_hover_03']};
}
...
input::-webkit-input-placeholder { color: {$colors['input_text']}; }
input::-moz-placeholder          { color: {$colors['input_text']}; }
input:-ms-input-placeholder      { color: {$colors['input_text']}; }
textarea::-webkit-input-placeholder { color: {$colors['input_text']}; }
textarea::-moz-placeholder          { color: {$colors['input_text']}; }
textarea:-ms-input-placeholder      { color: {$colors['input_text']}; }
...
.sc_button_bordered:not(.sc_button_bg_image) .sc_button_icon{
	color:{$colors['text_link']};
}
...
.sc_button_bordered:not(.sc_button_bg_image):hover .sc_button_icon{
	color:{$colors['inverse_link']} !important;
}
...
.sc_button.sc_button_alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image) {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
...
.sc_button.sc_button_alter:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	color: {$colors['text_dark']};
	border-color: {$colors['text_dark']};
	background-color: transparent;
}
.sc_button.sc_button_alter.inverse_button:not(.sc_button_simple):not(.sc_button_bordered):not(.sc_button_bg_image):hover {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
...
.post_item .post_featured.hover_shop .icons a:hover {
	color: {$colors['text_link']};
...
.post_layout_excerpt.sticky a.post_meta_item,
.post_layout_excerpt.sticky .post_date a{
	color: {$colors['text_light']};
}
...
.post_item_none_search .search_wrap .search_submit:hover::before, 
.post_item_none_archive .search_wrap .search_submit:hover::before {
	color: {$colors['inverse_link']};
}
...
.sc_layouts_menu_nav > li li.sfHover > a {
	background-color: {$colors['extra_bg_color_016']};
}
...
.alex_stone_tabs .alex_stone_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton > span {
...
.alex_stone_tabs .alex_stone_tabs_titles li.ui-state-active a {
...
.post_excerpt_info .post_meta_item a{
	color: {$colors['text_light']};
}
.post_excerpt_info .post_meta_item:hover,
.post_excerpt_info .post_meta_item a:hover{
	color: {$colors['text_link']};
}
.post_excerpt_info .post_meta_item.post_categories{
	color: transparent;
}
.post_excerpt_info .post_meta_item.post_categories a {
	color: {$colors['inverse_link']};
	border-color: {$colors['text_link']};
	background-color: {$colors['text_link']};
}
.post_excerpt_info .post_meta_item.post_categories a:hover {
	color: {$colors['text_link']};
	background-color: transparent;
}
...
.scheme_self.sidebar aside input{
	color: {$colors['inverse_link']};
	background-color: {$colors['bg_color_02']};
	border-color: transparent;
}
.scheme_self.sidebar aside input:focus,
.scheme_self.sidebar aside input:hover{
	color: {$colors['inverse_link']};
	background-color: {$colors['bg_color_02']};
	border-color: {$colors['bg_color_02']};
}
.scheme_self.sidebar aside input::-webkit-input-placeholder { color: {$colors['inverse_link']}; }
.scheme_self.sidebar aside input::-moz-placeholder          { color: {$colors['inverse_link']}; }
.scheme_self.sidebar aside input:-ms-input-placeholder      { color: {$colors['inverse_link']}; }

.scheme_self.sidebar .widget_search form:after, 
.scheme_self.sidebar .woocommerce.widget_product_search form:after, 
.scheme_self.sidebar .widget_display_search form:after, 
.scheme_self.sidebar #bbpress-forums #bbp-search-form:after {
	color: {$colors['inverse_link']};
}

.scheme_self.sidebar .widget_search form:hover::after, 
.scheme_self.sidebar .woocommerce.widget_product_search form:hover::after, 
.scheme_self.sidebar .widget_display_search form:hover::after, 
.scheme_self.sidebar #bbpress-forums #bbp-search-form:hover::after {
	color: {$colors['inverse_link_08']};
}

/* Widgets */
.widget li.recentcomments span:before {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
...
.scheme_self.footer_wrap .widget_area .post_item .post_title, 
.scheme_self.footer_wrap .widget_area .post_item .post_title a, 
.scheme_self.footer_wrap .widget .post_item .post_title a,
.scheme_self.footer_wrap .widget .post_item .post_title {
	color: {$colors['text']};
}
.footer_wrap .widget_area .post_item .post_title a:hover, 
.footer_wrap .widget .post_item .post_title a:hover,
.scheme_self.footer_wrap .widget_area .post_item .post_title a:hover, 
.scheme_self.footer_wrap .widget .post_item .post_title a:hover{
	color: {$colors['text_link']};
}
.footer_wrap .post_info .post_info_item a,
.scheme_self.footer_wrap .post_info .post_info_item a{
	color: {$colors['text_light']};
}
.footer_wrap .post_info .post_info_item a:hover,
.scheme_self.footer_wrap .post_info .post_info_item a:hover{
	color: {$colors['text_link']};
}

.footer_wrap .widget.widget_nav_menu li a,
.scheme_self.footer_wrap .widget.widget_nav_menu li a{
	color: {$colors['text']};
}
.footer_wrap .widget.widget_nav_menu li a:hover,
.scheme_self.footer_wrap .widget.widget_nav_menu li a:hover{
	color: {$colors['text_link']};
}

.footer_widgets_wrap + .footer_copyright_wrap {
	border-color: {$colors['text_dark_013']};
}
...
.wp-block-pullquote.has-cyan-bluish-gray-background-color blockquote *:not(code),
...
.trx_addons_absent.header_style_header-custom-header-default .top_panel_title.scheme_dark{
	background-color: {$colors['text_link']};
}
...
CSS;
					...
					$rez = apply_filters('alex_stone_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'alex_stone_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>