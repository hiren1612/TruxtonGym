...
?>">
	...
	<div class="sc_services_item_info">
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button color_style_default sc_button_default sc_button_size_normal"><?php esc_html_e('Read more', 'alex-stone'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
