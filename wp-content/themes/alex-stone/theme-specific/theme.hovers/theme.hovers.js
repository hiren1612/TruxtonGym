...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (ALEX_STONE_STORAGE['button_hover'] && ALEX_STONE_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.alex_stone_tabs .alex_stone_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+ALEX_STONE_STORAGE['button_hover']);
		if (ALEX_STONE_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.sidebar .trx_addons_tabs .trx_addons_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
				.alex_stone_tabs .alex_stone_tabs_titles li a:not([class*="sc_button_hover_style_"]),\
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+ALEX_STONE_STORAGE['button_hover']);
