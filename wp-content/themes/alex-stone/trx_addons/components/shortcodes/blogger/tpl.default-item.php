	...
	?><div class="sc_blogger_item_content entry-content"><?php
		...
		if ( !in_array($post_format, array('link', 'aside', 'status', 'quote')) ) {
			...
			?><div class="sc_blogger_item_excerpt">
				<?php
				// More button
					?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="sc_button color_style_default sc_button_default sc_button_size_normal"><?php esc_html_e('Read more', 'alex-stone'); ?></a></div>
