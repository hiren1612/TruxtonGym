...
if ( !function_exists( 'alex_stone_woocommerce_get_css' ) ) {
	add_filter( 'alex_stone_filter_get_css', 'alex_stone_woocommerce_get_css', 10, 4 );
	function alex_stone_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
.woocommerce div.product form.cart div.quantity input[type="number"]:hover, .woocommerce-page div.product form.cart div.quantity input[type="number"]:hover,
.woocommerce .shop_table.cart input[type="number"]:hover, .woocommerce-page .shop_table.cart div.quantity input[type="number"]:hover {
	color: {$colors['input_dark']};
...
/* Buttons */
.alex_stone_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.alex_stone_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
...
/* Icons */
.list_products form .woocommerce_thumbs,
.list_products form .woocommerce_list {
	color: {$colors['alter_bg_color']};
}
.list_products form .woocommerce_thumbs:hover,
.list_products form .woocommerce_list:hover {
	color: {$colors['text_dark']};
}
.list_products.shop_mode_thumbs form .woocommerce_thumbs {
	color: {$colors['text_dark']};
}
.list_products.shop_mode_list form .woocommerce_list {
	color: {$colors['text_dark']};
}
