...
if (!function_exists('alex_stone_trx_addons_get_css')) {
	add_filter('alex_stone_filter_get_css', 'alex_stone_trx_addons_get_css', 10, 4);
	function alex_stone_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.slider_swiper_outer.slider_outer_pagination_pos_bottom_outside .swiper-pagination-bullet:before {
	background-color: {$colors['text_link']};
}
...
.scheme_self.footer_wrap .widget_title, 
...
/* Countdown */
.sc_countdown_default .sc_countdown_digits span,
.scheme_self.sc_countdown_default .sc_countdown_digits span {
	color: {$colors['text_dark']};
	border-color: transparent;
	background-color: transparent;
}
...
.scheme_self.sc_countdown .sc_countdown_label,
.scheme_self.sc_countdown_circle .sc_countdown_digits {
	color: {$colors['text_dark']};
	border-color: transparent;
	background-color: transparent;
}
...
.sc_courses .sc_courses_item_categories {
	background-color: {$colors['alter_dark']};
}
.sc_courses .sc_courses_item_categories a {
	color: {$colors['bg_color']};
}
.sc_courses .sc_courses_item_categories a:hover {
	color: {$colors['alter_link']};
}
.sc_courses .sc_courses_item_meta {
	color: {$colors['alter_light']};
...
.sc_courses .sc_courses_item_meta .sc_courses_item_meta_item{
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
...
.sc_courses .sc_courses_item .trx_addons_hover_mask {
	background-color: {$colors['text_link3']};
}
.courses_single .courses_page_meta {
	color: {$colors['text_light']};
}
.courses_single .courses_page_meta_duration,
.courses_single .courses_page_meta_date,
...
.serv_link_br .sc_icons.sc_icons_modern .sc_icons_item:hover {
	border-color: {$colors['extra_bd_color']};
}
...
.sc_price_item.with_image .sc_price_item_label {
	background-color: {$colors['text_link']};
	color: {$colors['inverse_link']};
}
...
.scheme_self.footer_wrap .socials_wrap .social_item .social_icon {
	color: {$colors['extra_link3']};
	background-color: {$colors['extra_link2_007']};
}
...
.content .scheme_self .socials_wrap .social_item .social_icon {
	background-color: {$colors['extra_link2']};
}
.content .scheme_self .socials_wrap .social_item .social_icon,
.content .scheme_self .socials_wrap .social_item .social_icon i {
	color: {$colors['extra_light']};
}
.content .scheme_self .socials_wrap .social_item:hover .social_icon {
	background-color: {$colors['extra_hover2']};
}
.content .scheme_self .socials_wrap .social_item:hover .social_icon,
.content .scheme_self .socials_wrap .social_item:hover .social_icon i {
	color: {$colors['extra_hover3']};
}
...
.scheme_self.sc_testimonials_item_content {
	color: {$colors['text']};
}
...
.sc_button_only_icon:before {
	background-color: {$colors['text_link']};
}
.sc_button_only_icon:hover {
	background-color: {$colors['text_link']} !important;
}
