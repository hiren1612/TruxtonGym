...
?>">
	...
	if ( has_post_thumbnail() && $args['featured']=='image') {
		trx_addons_get_template_part('templates/tpl.featured.php',
										...
										apply_filters('trx_addons_filter_args_featured', array(
															...
															'hover' => 'zoomin',
															'thumb_size' => apply_filters('trx_addons_filter_thumb_size', alex_stone_get_thumb_size($args['columns'] > 2 ? 'med-alt' : 'big'), 'services-default')
															),
														'services-default'
														)
									);
	...
	<div class="sc_services_item_info">
		...
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			...
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button color_style_default sc_button_default sc_button_size_normal"><?php esc_html_e('Read more', 'alex-stone'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
